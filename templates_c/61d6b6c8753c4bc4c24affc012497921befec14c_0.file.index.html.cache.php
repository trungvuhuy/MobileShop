<?php
/* Smarty version 3.1.30, created on 2016-08-21 16:42:56
  from "D:\Working\VNPT\Training\PHPMVC\Project\MobileShop\templates\index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_57b9da107f45e1_88959316',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '61d6b6c8753c4bc4c24affc012497921befec14c' => 
    array (
      0 => 'D:\\Working\\VNPT\\Training\\PHPMVC\\Project\\MobileShop\\templates\\index.html',
      1 => 1471797771,
      2 => 'file',
    ),
  ),
...
function content_57b9da107f45e1_88959316 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '2861357b9da100466a1_53770038';
?>
<!DOCTYPE html>
<!--[if IE]><![endif]-->
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="main-menu">
                            <nav>
                                <ul>
                                    <li class="bias"><a href="index.php">Trang chủ</a>
                                    </li>
                                    ...
                                    <li><a href="#">Sản phẩm khuyến mại</a>
    ...
    <div class="slider-area an-1 hm-1 clr">
        ...
        <div class="bend niceties preview-2">
            <div id="ensign-nivoslider" class="slides">
                <img src="img/slider/slider1-bg.jpg" alt="" title="#slider-direction-1" />
                <img src="img/slider/slider2-bg.jpg" alt="" title="#slider-direction-2" />
                <img src="img/slider/slider3-bg.jpg" alt="" title="#slider-direction-3" />
            </div>
            <!-- direction 1 -->
            <div id="slider-direction-1" class="t-cn slider-direction">
                ...
                <!-- layer 1 -->
                <div class="layer-1-2">
                    <img src="img/slider/slider1-for.png" alt="" />
                </div>
            </div>
            <!-- direction 2 -->
            <div id="slider-direction-2" class="slider-direction">
                ...
                <!-- layer 1 -->
                <div class="layer-1-1">
                    <img src="img/slider/slider2-for.png" alt="" />
                </div>
            </div>
            <!-- direction 3 -->
            <div id="slider-direction-3" class="slider-direction">
                ...
                <!-- layer 1 -->
                <div class="layer-1">
                    <img src="img/slider/slider3-for.png" alt="" />
                </div>
            </div>
        </div>
        <!-- slider end-->
                            ...
                            <div class="total-hotsell">
                                <div class="single-hotsell aside-padd">
                                    <div class="hotsell-img">
                                        <a href="#"><img src="img/product/books1.jpg" alt=""></a>
                                    </div>
                                    <div class="hotsell-text">
                                        ...
                                        <span class="new-price">$222.00</span>
                                        <span class="old-rpice"><del>Sale:$250.00</del></span>
                                    </div>
                                </div>
                                <!--Single hotsell-->
                                <div class="single-hotsell aside-padd">
                                    <div class="hotsell-img">
                                        <a href="#"><img src="img/product/books2.jpg" alt=""></a>
                                    </div>
                                    <div class="hotsell-text">
                                        <a href="">Quisque in arcu</a>
                                        <div class="rating">
                                ...
                                <div class="single-hotsell aside-padd">
                                    <div class="hotsell-img">
                                        <a href="#"><img src="img/product/books3.jpg" alt=""></a>
                                    </div>
                                    <div class="hotsell-text">
                                        <a href="">Quisque in arcu</a>
                                        <div class="rating">
                                ...
                                <div class="single-hotsell aside-padd">
                                    <div class="hotsell-img">
                                        <a href="#"><img src="img/product/books4.jpg" alt=""></a>
                                    </div>
                                    <div class="hotsell-text">
                                        <a href="">Quisque in arcu</a>
                                        <div class="rating">
                    ...
                    <div class="ambit-key">
                        ...
                        <div class="our-product-area top-pd featur-padd">
                            ...
                            <div class="features-tab">
                                ...
                                <ul class="nav">
                                    ...
                                    <li role="presentation"><a href="#new" data-toggle="tab"><i class="fa fa-arrow-circle-o-down"></i>New Arrivals</a></li>
                                    <li role="presentation"><a href="#profile" data-toggle="tab"><i class="fa fa-star-o"></i>Random Products</a></li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
                                    ...
                                    <!--================================New Arrival================================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn carousle-pagi fade in" id="new">
                                        <div class="row row-margin">
                                            <div class="feature-carousel pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                                    ...
                                    <!--=========================Random Products===============================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn carousle-pagi fade in" id="profile">
                                        <div class="row row-margin">
                                            <div class="feature-carousel pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                        ...
                        <div class="advertise-area mt10">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="single-add vina-banner">
                                    <a href="#"><img src="img/banner/banner-home-content1.png" alt="" /> </a>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="single-add vina-banner">
                                    <a href="#"><img src="img/banner/banner-home-content2.png" alt="" /></a>
                                </div>
                            </div>
                        </div>
                        <!--advertise area end-->
                        ...
                        <div class="our-product-area best-offere featur-padd mt25">
                            ...
                            <div class="features-tab">
                                <!-- Nav tabs -->
                                <ul class="nav">
                                    <li role="presentation" class="active"><a href="#home2" data-toggle="tab"><i class="fa fa-list"></i>Watches</a></li>
                                    <li role="presentation"><a href="#new2" data-toggle="tab"><i class="fa fa-arrow-circle-o-down"></i>Books</a></li>
                                    <li role="presentation"><a href="#profile2" data-toggle="tab"><i class="fa fa-star-o"></i>Sports</a></li>
                                </ul>
                                <div class="row">
                                    <!-- Tab panes -->
                                    <div class="tab-content">
                                                ...
                                                <div class="feature-carousel-tab">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-padd">
                                                        <div class="single-product">
                                                            ...
                                                            <div class="product-img">
                                                                <a href="#">
                                                                    <img class="primary-image" src="img/product/watch1.jpg" alt="" />
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <h2 class="product-name"><a href="#">Donec ac tempus</a></h2>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-padd">
                                                        <div class="single-product">
                                                            ...
                                                            <div class="product-img">
                                                                <a href="#">
                                                                    <img class="primary-image" src="img/product/watch2.jpg" alt="" />
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <h2 class="product-name"><a href="#">Donec ac tempus</a></h2>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-padd">
                                                        <div class="single-product">
                                                            ...
                                                            <div class="product-img">
                                                                <a href="#">
                                                                    <img class="primary-image" src="img/product/watch3.jpg" alt="" />
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <h2 class="product-name"><a href="#">Donec ac tempus</a></h2>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-padd">
                                                        <div class="single-product">
                                                            ...
                                                            <div class="product-img">
                                                                <a href="#">
                                                                    <img class="primary-image" src="img/product/watch4.jpg" alt="" />
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <h2 class="product-name"><a href="#">Donec ac tempus</a></h2>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-padd">
                                                        <div class="single-product">
                                                            ...
                                                            <div class="product-img">
                                                                <a href="#">
                                                                    <img class="primary-image" src="img/product/watch5.jpg" alt="" />
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <h2 class="product-name"><a href="#">Donec ac tempus</a></h2>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-padd">
                                                        <div class="single-product">
                                                            ...
                                                            <div class="product-img">
                                                                <a href="#">
                                                                    <img class="primary-image" src="img/product/watch6.jpg" alt="" />
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <h2 class="product-name"><a href="#">Donec ac tempus</a></h2>
                        ...
                        <div class="our-product-area recently-bought featur-padd">
                            ...
                            <div class="features-tab">
                                <!-- Nav tabs -->
                                <ul class="nav">
                                    <li role="presentation" class="active"><a href="#home3" data-toggle="tab"><i class="fa fa-list"></i>Gift</a></li>
                                    <li role="presentation"><a href="#new3" data-toggle="tab"><i class="fa fa-arrow-circle-o-down"></i>Health</a></li>
                                    <li role="presentation"><a href="#profile3" data-toggle="tab"><i class="fa fa-star-o"></i>Medical</a></li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
                                    ...
                                    <!--================================helath================================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn carousle-pagi fade in" id="new3">
                                        <div class="row row-margin">
                                            <div class="feature-carousel pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                                    ...
                                    <!--=========================medical===============================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn carousle-pagi fade in" id="profile3">
                                        <div class="row row-margin">
                                            <div class="feature-carousel pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                        ...
                        <div class="our-product-area our-favourites featur-padd">
                            <!-- area title start -->
                            <div class="area-title bdr mt5">
                            ...
                            <div class="features-tab">
                                ...
                                <ul class="nav">
                                    <li role="presentation" class="active">
                                        <a href="#electronic" data-toggle="tab">
                                            <div class="tab-img"><img src="img/electronics.png" alt=""> electronic</div>
                                        </a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#clothing" data-toggle="tab">
                                            <div class="tab-img"><img src="img/clothing.png" alt=""> clothing</div>
                                        </a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#equipment" data-toggle="tab">
                                            <div class="tab-img"><img src="img/equipments.png" alt=""> equipment</div>
                                        </a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#jwelary" data-toggle="tab">
                                            <div class="tab-img"><img src="img/jewellery.png" alt=""> jwelary</div>
                                        </a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#health" data-toggle="tab">
                                            <div class="tab-img"><img src="img/health.png" alt=""> health</div>
                                        </a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#medical" data-toggle="tab">
                                            <div class="tab-img"><img src="img/medical.png" alt=""> Medical</div>
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <!-- product section end -->
                                    <!--===============================electronic==============================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn fade in active" id="electronic">
                                        <div class="row row-margin">
                                            <div class="feature-carousel-np pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                                                    <div class="single-product">
                                                        <div class="product-label">
                                    ...
                                    <!--================================clothing================================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn fade in" id="clothing">
                                        <div class="row row-margin">
                                            <div class="feature-carousel-np pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                                    ...
                                    <!--================================equipment===============================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn fade in" id="equipment">
                                        <div class="row row-margin">
                                            <div class="feature-carousel-np pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                                    ...
                                    <!--===============================jwelary==============================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn fade in" id="jwelary">
                                        <div class="row row-margin">
                                            <div class="feature-carousel-np pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                                    ...
                                    <!--================================health================================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn fade in" id="health">
                                        <div class="row row-margin">
                                            <div class="feature-carousel-np pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                                    ...
                                    <!--================================medical===============================-->
                                    <div role="tabpanel" class="tab-pane carousel-btn fade in" id="medical">
                                        <div class="row row-margin">
                                            <div class="feature-carousel-np pt20 pb20">
                                                <!-- single-product start -->
                                                <div class="col-xs-12 col-padd">
                        ...
                        <div class="advertise-area mt10">
                            <div class="col-md-6 col-sm-6">
                                <div class="single-add vina-banner">
                                    <a href="#"><img src="img/banner/banner-home-content3.png" alt="" /> </a>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="single-add vina-banner">
                                    <a href="#"><img src="img/banner/banner-home-content4.png" alt="" /></a>
                                </div>
                            </div>
                        </div>
                        <!--advertise area2 end-->
