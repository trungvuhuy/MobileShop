<?php
/* Smarty version 3.1.30, created on 2016-08-21 16:39:36
  from "D:\Working\VNPT\Training\PHPMVC\Project\MobileShop\templates\contact.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_57b9d948709090_00659077',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bc3716c913c4e0b768b8e43d839e30b743422d7b' => 
    array (
      0 => 'D:\\Working\\VNPT\\Training\\PHPMVC\\Project\\MobileShop\\templates\\contact.html',
      1 => 1468817308,
      2 => 'file',
    ),
  ),
...
function content_57b9d948709090_00659077 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '1994457b9d94860a3a0_26759221';
?>
<!DOCTYPE html>
<!--[if IE]><![endif]-->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="map-area">
                    ...
                    <div class="quick-details mt20">
                       <h3>Quick Details</h3>
                    <address>
                       <p>12345 North Main Street, Seattle, WA 00000, USA</p>
                       <p>Phone: 0123 091234598</p>
                       <p>Fax: 800 0123 091234</p>
                       <p>Email: support@bootexparts.com</p>
                       <a href="#">Web: bootexparts.com</a>
                   </address>
                        <a href="#" class="button c_button dis-left">
                            <span><i class="fa fa-map-marker"></i>View Google Map</span>
                        </a>
                    </div>
                </div>
                <div class="contact-form-area">
                    ...
                    <form method="post" action="mail.php">
                        ...
                        <div class="input-box">
                            ...
                            <textarea placeholder="Enter Your Text Here..." name="message"></textarea>
                        </div>
                        <div class="input-box checkout">
                            <input type="submit" value="Submit" name="submit" class="button c_button">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-spbottom">
                    <div class="ss-title">
                        <h3>Clothing</h3></div>
                    <div class="ss-img">
                        <a href="#"><img src="img/bottom-menu-1.jpg" alt=""></a>
                    </div>
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-spbottom">
                    <div class="ss-title">
                        <h3>Sports</h3></div>
                    <div class="ss-img">
                        <a href="#"><img src="img/bottom-menu-2.jpg" alt=""></a>
                    </div>
                    <div class="bottom-menulist">
                        <ul>
                            <li><a href="">Medical</a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="single-spbottom">
                    <div class="ss-title">
                        <h3>Laptops</h3></div>
                    <div class="ss-img">
                        <a href="#"><img src="img/bottom-menu-3.jpg" alt=""></a>
                    </div>
                    <div class="bottom-menulist">
                        <ul>
                            <li><a href="">Medical</a></li>
            ...
            <div class="col-md-3 hidden-sm col-xs-12">
                <div class="single-spbottom">
                    <div class="ss-title">
                        <h3>Talevision</h3></div>
                    <div class="ss-img">
                        <a href="#"><img src="img/bottom-menu-4.jpg" alt=""></a>
                    </div>
                    <div class="bottom-menulist">
                        <ul>
                            <li><a href="">Medical</a></li>
...
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBuU_0_uLMnFM-2oWod_fzC0atPZj7dHlU"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
