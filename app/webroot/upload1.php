 ...
 // script để thực hiện quá trình upload
	...
	*/
	function getLink($i) {
		...
		$return = "<tr><td colspan=\"2\"><a href=\"javascript:window.opener.document.getElementById('imagesid1').value = '$link_bs';window.opener.document.imagesdefault1.src='$link1';window.close();window.history.go(1);\">close</a></td> </tr></table>";
		return $return;
	}
}
?>
