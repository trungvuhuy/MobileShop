	...
	<div class="border">
		<div class="padding">
			...
			<div class="m">
				...
				<div class="header icon-48-langmanager">Thêm mới bài viết</div>
				<div class="clr"></div>
			</div>
			...
			<div id="element-box">
				<div class="t"><div class="t"><div class="t"></div></div></div>
				<div class="m">
				<form action="<?php echo DOMAIN?>/news/admin_add" method="post" name="adminForm" enctype="multipart/form-data" id="adminForm" autocomplete="off">
