...
<div id="content-box">
	<div class="border">
		<div class="padding">
			...
			<div class="m">
				...
				<div class="header icon-48-langmanager">Thay đổi thông tin sản phẩm</div>
				<div class="clr"></div>
			</div>
			...
			<div id="element-box">
				<div class="t"><div class="t"><div class="t"></div></div></div>
				<div class="m">
				<form action="<?php echo DOMAIN?>/products/admin_edit" method="post" name="adminForm" enctype="multipart/form-data" id="adminForm" autocomplete="off">
					<div class="col width-60">
						...
						<tr>
							...
							<td>
								  ...
								  <?php echo $form->input('Product.id',array( 'label' => '','id'=>'txtTitle','class'=>'validate[required] inputbox','size'=>'40'));?>
							</td>
						</tr>
						<!-- danh mục sản phẩm -->
						<tr>
						...
						<tr>
							<td class="key">
								<label for="txtDonvi">Đơn vị tính</label>
							</td>
							<td>
								 <?php	echo $this->Form->input('Product.sale',array('label' => '','type'=>'text','class'=>'inputbox','id'=>'txtDonvi')); ?> &nbsp;&nbsp;&nbsp;( Ví dụ: Bộ, Chiếc...)
							</td> 
						</tr>
						<!--tr>
							<td class="key">
								<label for="ddlLocal">Số lượng  <span style="color:#F00; font-weight:bold;">(*)</span></label>
							</td>
							<td class="keke" >
							<?php echo $form->input('Product.quantity',array( 'label' => '','id'=>'txtQuantity','class'=>'validate[required] inputbox','size'=>'40'));?>
								
							</td>
						</tr-->
						<!--tr>
							<td class="key">
								<label for="chekActive">Tình trạng sản phẩm (còn-hết hàng)</label>
							</td>
							<td>
								 <?php	echo $this->Form->input('Product.action',array('type'=>'checkbox','label'=>false,'class'=>'inputbox','id'=>'chekActiveAction','style'=>'width:12px;')); ?>
							</td>
						</tr-->
						<tr>
							<td class="key">
    ...
    <div class="functionBtnEvent" style="width:100%; padding-left:11px;"><img id="images-default" name="imagesdefault4" src="<?php echo DOMAIN ?>/img/no-images.jpg" width="100"></img></div>
					...
					<div class="col width-40">
						...
						<tr>
							<td class="key">
								<label for="checkActive">Sản phẩm nổi bật</label>
							</td>
							<td>
								 <?php	echo $this->Form->input('Product.prominent',array('type'=>'checkbox','label'=>false,'class'=>'inputbox','id'=>'checkActive','style'=>'width:12px;')); ?>
							</td>
						</tr>
						<tr>
							<td class="key">
